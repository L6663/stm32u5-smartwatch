...
/** Callback to call when the animation is deleted */
 ...
 * @param a           pointer to an initialized lv_anim_t
 * @param deleted_cb  callback called before the animation is freed
 */
static inline void lv_anim_set_deleted_cb(
    lv_anim_t * a,
    lv_anim_deleted_cb_t deleted_cb)
{
